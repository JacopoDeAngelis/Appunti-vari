...
\lstinputlisting[language=java]{code/066}\label{code: 066}
...
\lstinputlisting[language=java]{code/067}\label{code: 067}
...
\lstinputlisting[language=java]{code/068}\label{code: 068}
...
\lstinputlisting[language=java]{code/069}\label{code: 069}
è meglio di
\lstinputlisting[language=java]{code/070}\label{code: 070}

\subsection{Evitare le condizioni negative}
\lstinputlisting[language=java]{code/071}\label{code: 071}
è meglio di
\lstinputlisting[language=java]{code/072}\label{code: 072}

\subsection{Le funzioni dovrebbero fare una sola cosa}
\lstinputlisting[language=java]{code/073}\label{code: 073}
è molto meno comprensibile rispetto a
\lstinputlisting[language=java]{code/074}\label{code: 074}
